...
public class DiaryInfoIoFacadeTest {
    ...
    public void inputTest() {
        ...
        System.out.println(facade.readDiaryInfo(DIR + File.separator + PathUtils.getRelativePath(date[0],date[1],date[2])));
    }
    ...
    public DiaryInfo buildDiaryInfo() {
        ...
        Integer[] date = DateUtils.getYearMouthDay(System.currentTimeMillis());
        metaInfo.setFilePath(DIR + File.separator + PathUtils.getRelativePath(date[0],date[1],date[2]));
        metaInfo.setId(1);
